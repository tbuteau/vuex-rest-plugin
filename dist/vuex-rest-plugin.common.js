...
function formatUrl(payload) {
  ...
  if (payload.query && lodash_es_isObject(payload.query)) {
    ...
    var query = lodash_es_map(payload.query, function (value, key) {
      ...
      if (lodash_es_isFunction(value.toISOString) || lodash_es_isDate(value)) {
...
var Actions_Actions = function Actions(axios, models, dataPath) {
  ...
  this.reset = function (context) {
    lodash_es_values(context.state).forEach(function (s) {
      return s.reset();
    });
  };
};
    ...
    lodash_es_forEach(this.models, function (model) {
      ...
      _this.mutations["DELETE_".concat(model.name.toUpperCase())] = function (myState, item) {
        ...
        if (lodash_es_isArray(item)) {
          lodash_es_forEach(item, deleteItem);
        } else {
          deleteItem(item);
        }
...
function () {
  ...
  _createClass(ApiState, [{
    ...
    key: "hasAction",
    get: function get() {
      return lodash_es_some(this.actionQueue, function (a) {
        return !lodash_es_isEmpty(a);
      });
    }
  }]);
...
function (_ApiState) {
  ...
  function DateTimeState() {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(DateTimeState).call(this));
    _this.from = null;
    _this.to = null;
    return _this;
  }
...
/******/ });
//# sourceMappingURL=vuex-rest-plugin.common.js.map